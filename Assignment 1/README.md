...
eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        ...
        ether 00:15:5d:9c:b3:xx  txqueuelen 1000  (Ethernet)
...
- IP address is: `172.23.237.68`.
- HW address is: `00:15:5d:9c:b3:xx`.
  *hiding my hardware addresse in this snapshot of code for security concerns.
...
1. Average RTT is: `107.571 ms`.
2. Packet Loss is: `0%`.
3. Size of packet sent ot `www.facebook.com` is: `64 bytes`.
...
1. IP Address of `www.iiests.ac.in` is: `14.139.223.183`.
2. IP Address of DNS server is: `172.23.224.1#53`.
...
1. Number of hops between my machine and `www.facebook.com` is: `11`.
2. IP address of my network gateway is: `172.23.224.1`.
...
MAC address of the device that is performing as my network gateway is: `00:15:5d:92:3f:54`.
...
- IP address of `www.facebook.com` is: `31.13.79.35`.
- Doing a reversse domain lookup I got: `edge-star-mini-shv-02-bom1.facebook.com.`
